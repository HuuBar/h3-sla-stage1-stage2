...
DATA_BASE=/mnt/share/c50058431/c50058431/dataset/ir5k_gen_latent_cache_768p_stage2_2493_sub1000
MODEL_BASE=/mnt/weight/MiniMax/MiniMax-H3/FL2VA
CKPT=/mnt/share/c50058431/c50058431/minimax_dmd/models/train/MiniMax-H3-T2VA-SLA-768p-2493-156-opencomp-proj-cont/step-300-merged.safetensors
OUT=$REPO/models/train/MiniMax-H3-T2VA-SLA-768p-2493-156-opencomp-proj-1000
...
CKPT_LINK=/mnt/share/c50058431/c50058431/dataset/transformer_step300_merged_link.safetensors
...
echo "[$(date '+%F %T')] ==== SLA proj-only 再训(单卡): opencomp step-156 起点, teacher-align, lr=1e-4, 768p 累计300 续训: 1000 样本子集, 1000 步 ===="
