...
DATA_BASE=/mnt/share/c50058431/c50058431/dataset/ir5k_gen_latent_cache_768p_stage2_2493_sub500
...
echo "[$(date '+%F %T')] ==== SLA proj-only 再训(单卡): opencomp step-156 起点, teacher-align, lr=1e-4, 768p 500 样本子集, 500 步 ===="
